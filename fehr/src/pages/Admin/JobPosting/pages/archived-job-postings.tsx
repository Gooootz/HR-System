...
import { GetAllClosedJobPostingHook } from "../hooks/job-posting.hook";
...
const ArchivedJobPosting = () => {
  const navigate = useNavigate();
  const { data: jobPostings, isLoading, isError } = GetAllClosedJobPostingHook();
  ...
  useEffect(() => {
    if (jobPostings) {
      const filtered = jobPostings.filter((jobPosting: any) => {
              ...
              <div className="flex flex-col justify-between h-full">
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(`/admin/job-posting-info/${jobPosting.id}`)
                    }
                  >
                    View
                  </Button>
...
export default ArchivedJobPosting;
